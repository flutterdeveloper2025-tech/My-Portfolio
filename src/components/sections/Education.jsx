...
import {fadeUp,scaleIn,stagger,G,C} from "../../utils/theme";
    ...
    <section id="education" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <motion.div ref={ref} initial="hidden" animate={inView?"show":"hidden"} variants={stagger} className="mb-14">
          <motion.p variants={fadeUp} className="font-mono text-sm mb-2" style={{color:"#8b5cf6"}}>{"// education & certifications"}</motion.p>
          <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-black text-white mb-3">
            <span style={{background:G.purple,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Education</span> & Certs
          </motion.h2>
        </motion.div>
