...
export default function Footer(){
  return(
    <footer className="py-10 px-6 relative" style={{borderTop:"1px solid rgba(139,92,246,0.12)"}}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          <p className="font-black text-white text-lg mb-1" style={{background:"linear-gradient(135deg,#a78bfa,#7c3aed)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>
            Muhammad Anas Raza
          </p>
