    ...
    <section id="contact" className="py-24 relative">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10">
        <motion.div ref={ref} initial="hidden" animate={inView?"show":"hidden"} variants={stagger} className="mb-14">
          <motion.p variants={fadeUp} className="font-mono text-sm mb-2" style={{color:"#8b5cf6"}}>{"// let's connect"}</motion.p>
          <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-black text-white mb-3">
            Get In <span style={{background:G.purple,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Touch</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-sm" style={{color:"rgba(148,163,184,0.6)"}}>Available for full-time roles & infrastructure projects. Let's talk!</motion.p>
        </motion.div>
